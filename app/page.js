...
const howItWorks = [
  { step: "Sign Up", description: "Create your free Calendly Clone account" },
  {
    ...
    <main className="container mx-auto px-4 py-16">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <p className="text-xl text-gray-600 mb-10">
            Calendly Clone helps you manage your time effectively. Create
            events, set your availability, and others book time with you
            seamlessly.
          </p>
          <Link href="/dashboard">
      ...
      <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
        ...
        <p className="text-xl mb-6">
          Join thousands of professionals who trust Calendly Clone for efficient time management
        </p>
        <Link href={"/dashboard"}>
